...
import { TrendingUp, Target, CheckCircle, Zap, BookOpen, Brain, ArrowRight } from 'lucide-react';
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="card p-6">
          ...
          {!data?.weakAreas?.length ? (
            <EmptyState icon={CheckCircle} title="No weak areas yet!" desc="Start practicing to see your analytics"/>
          ) : (
